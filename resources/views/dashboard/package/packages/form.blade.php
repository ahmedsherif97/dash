                                ...
                                <div class="d-flex justify-content-between">
                                    <nav class="breadcrumb-one" aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-3 py-2">
                                            ...
                                            <li class="breadcrumb-item" ><a href="{{route('dashboard.package.packages.index')}}">{{__('dash.packages')}}</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">{{isset($model)? __('dash.edit'):__('dash.create')}}</li>
                                        </ol>
                                    </nav>
                                </div>
                                <form method="post"
                                      action="{{isset($model)?route('dashboard.package.packages.update', $model) : route('dashboard.package.packages.store')}}"
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-6">
                                            <label for="inputState">{{__('dash.price')}}</label>
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" name="title[ar]" class="form-control"
                                                   id="inputEmail4"
                                    ...
                                    <div class="form-row mb-3">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input required type="text" name="title[en]" class="form-control"
                                                   id="inputPassword4"
